  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        ...
        "template_vnk9w0i",     // Admin template name
        formRef.current,
        "vdiT9BAr83oR_wwso"         // Replace with your EmailJS public key
      )
      .then(
    ...
    emailjs
      .send(
        ...
        "template_vspiilz",          // User template name
        {
          fullName: formData.fullName,
          email: formData.email,
        },
        "vdiT9BAr83oR_wwso"         // Same public key
      )
      .then(
