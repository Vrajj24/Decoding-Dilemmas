...
emailjs
.sendForm(
"service_vg7ke6n", // Replace with your EmailJS service ID
"template_i9h8k15", // Admin template name
formRef.current,
"K-zOq_A-i2K9UCc6v" // Replace with your EmailJS public key
)
.then(
...
emailjs
.send(
"service_vg7ke6n", // Same service ID
"template_udkc0og", // User template name
{
fullName: formData.fullName,
email: formData.email,
},
"K-zOq_A-i2K9UCc6v" // Same public key
)
.then(
