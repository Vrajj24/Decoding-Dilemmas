...
emailjs
.sendForm(
"service_izrkstl", // Replace with your EmailJS service ID
"template_ifhzy0g", // Admin template name
formRef.current,
"9B6liKfpam_OVN1SW" // Replace with your EmailJS public key
)
.then(
...
emailjs
.send(
"service_izrkstl", // Same service ID
"template_1m9s15m", // User template name
{
fullName: formData.fullName,
email: formData.email,
},
"9B6liKfpam_OVN1SW" // Same public key
)
.then(
...
<input
  ...
  onChange={handleChange}
  pattern="^(\+91\s?[0-9]{10}|[0-9]{10})$"
  title="Enter a valid 10-digit number (with or without +91)"
  required
/>
</div>
