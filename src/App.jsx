...
emailjs
.sendForm(
  "service_e262hs7", // Replace with your EmailJS service ID
"template_9ojnvtv", // Admin template name
formRef.current,
"R7xf4yBBkWy0Mx7fY"  // Replace with your EmailJS public key
)
.then(
...
emailjs
.send(
"service_e262hs7", // Same service ID
"template_ec30j7u", // User template name
{
fullName: formData.fullName,
email: formData.email,
},
"R7xf4yBBkWy0Mx7fY" // Same public key
)
.then(
