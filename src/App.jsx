...
emailjs
.sendForm(
"service_ntx317o", // Replace with your EmailJS service ID
"template_vb6t2rk", // Admin template name
formRef.current,
"4hk63h0dryA8TkrKq" // Replace with your EmailJS public key
)
.then(
...
emailjs
.send(
"service_ntx317o", // Same service ID
"template_hc5t8b6", // User template name
{
fullName: formData.fullName,
email: formData.email,
},
"4hk63h0dryA8TkrKq" // Same public key
)
.then(
